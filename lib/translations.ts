...
export const translations = {
  en: {
    ...
    hero: {
      ...
      headlineAccent: "from Surabaya Health Polytechnic.",
  ...
  id: {
    ...
    hero: {
      ...
      headlineAccent: "dari Politeknik Kesehatan Surabaya.",
  ...
  es: {
    ...
    hero: {
      ...
      headlineAccent: "del Politécnico de Salud de Surabaya.",
  ...
  ja: {
    ...
    hero: {
      ...
      headlineAccent: "スラバヤ保健ポリテクニック出身。",
  ...
  fr: {
    ...
    hero: {
      ...
      headlineAccent: "de l'École polytechnique de santé de Surabaya.",
